...
namespace ComexII.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult ComexIIEstructuraPrecio()
        {
            return View();
        }
        ...
        public ActionResult ComexIITarifasCampañas()
        {
            return View();
        }
        ...
        public ActionResult ComexIIConsultaDetalleCliente()
        {
            return View();
        }

        public ActionResult ComexIIClonaDatos()
        {
            return View();
        }

        public ActionResult ComexIIConsultaClienteTarifado()
        {
            return View();
        }
        ...
        public ActionResult ComexIIConsultaCampañas()
        {
            return View();
        }
    }
